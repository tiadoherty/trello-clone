...
function SignupFormModal() {
	...
	useEffect(() => {
		...
		if (lastName.length > 50 || lastName.length < 2) errors["lastName"] = "❗Last name must be between 2-50 characters"
		...
		if (removeSpaces(businessName) === 0) errors["businessName"] = "❗Business name must include characters"
